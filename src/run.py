...
def run_sequential(args, logger):
    ...
    use_coach = args.name == 'copa' or args.name == 'coid'
    if use_coach:
        scheme["hier_decision"] = {"vshape": (1,), "dtype": th.uint8}
        if args.name == 'coid':
            scheme["pre_actions"] = {"vshape": args.n_actions, "group": "agents"}
            scheme["pre_role"] = {"vshape": args.rnn_hidden_dim, "group": "agents"}
